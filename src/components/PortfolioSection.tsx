                  ...
                  >
                    ...
                    >
                      ...
                      <div className="p-6 space-y-4 bg-white">
                        ...
                        {isCenter && (
                          <div className="pt-2">
                            <Link to={project.link} className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors group">
